...
Se adopta [docs/architecture/data_governance.md](../architecture/data_governance.md) como línea base técnica:
...
- La responsabilidad de anonimizar recae en `pipelines/data/download` (el único punto de contacto con fuentes externas, según [ADR 0002](0002_pipelines_vs_src_separation.md)) — para cuando un dato llega a `data/raw`, ya debe estar anonimizado.
